/* AdvisoryHub — global HTMX configuration, CSRF, and a11y.
 *
 * Loaded once (base.html) after htmx.min.js. Four jobs:
 ...
 *  3. Surface request *outcomes* to assistive tech: mark the swap target
 ...
 *  4. Move focus into a region that opts in with `data-focus-on-swap` after a
 ...
 *
 * Visible request feedback (success/error/warning toasts, including the
 * transport-failure surfacing that used to live here) is owned by
 * advisoryhub-toast.js, which listens for the same htmx:responseError /
 * htmx:sendError events.
 */
(function () {
  "use strict";
